...
async def strt(event):
    await event.reply(
        f"ᴀɴᴅᴀ ʜᴀʀᴜꜱ ʙᴇʀɢᴀʙᴜɴɢ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ ᴋᴇ ɢʀᴜᴘ/ᴄʜᴀɴɴᴇʟ ꜱᴀʏᴀ ᴜɴᴛᴜᴋ ᴍᴇʟɪʜᴀᴛ ᴍᴇᴅɪᴀ ʏᴀɴɢ ꜱᴀʏᴀ ʙᴀɢɪᴋᴀɴ, ᴊɪᴋᴀ ꜱᴜᴅᴀʜ ᴋʟɪᴋ ᴄᴏʙᴀ ʟɢɪ",
        buttons=[
            Button.url("GABUNG GRUP", url=f"https://t.me/tsstiingbb"),
            Button.url("GABUNG GRUP", url="https://t.me/tsstiingbb"),
        ],
    )
